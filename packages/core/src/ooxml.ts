export { openOfficePackage } from "./ooxml/zip-reader";
export type { OfficePackageArchive } from "./ooxml/zip-reader";
export { OFFICE_PACKAGE_LIMITS } from "./ooxml/types";
export type { OfficePackageInput, OfficePackageSignal } from "./ooxml/types";
