export const CHAT_LIMITS = Object.freeze({ commands: 1000, jsonLength: 32 * 1024 * 1024, jsonBytes: 32 * 1024 * 1024, conversations: 500, participants: 2000, members: 2000, messages: 20_000,
