...
import { createDataViewController } from "./controller";
export function useEditor(props: DataViewProps) {
  const [controller] = useState(() => createDataViewController(props.initialData, props));
